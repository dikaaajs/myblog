      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center">
              <Image src="/logo.png" alt="Blog Logo" width={120} height={40} className="h-8 w-auto" />
            </div>
            <p className="text-gray-400 text-sm leading-relaxed">
              Your trusted source for the latest technology news, reviews, and buying guides. Stay updated with the
              newest trends in smartphones, laptops, gaming, and more.
            </p>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/sitemap" className="text-gray-400 hover:text-yellow-400 transition-colors text-sm">
                  Sitemap
                </Link>
              </li>
            </ul>
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              ...
              <p className="text-gray-400 text-sm">
                Subscribe to get the latest tech news and reviews delivered to your inbox.
              </p>
              <div className="space-y-2">
                ...
                />
                <Button className="w-full bg-yellow-500 hover:bg-yellow-600 text-background">Subscribe</Button>
              </div>
            </div>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <div className="text-gray-400 text-sm">© 2024 TechBlog. All rights reserved.</div>
